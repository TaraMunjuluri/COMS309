...
```
cd existing_repo
git remote add origin https://git.las.iastate.edu/cs309/2024fall/2_mstafa_4.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.las.iastate.edu/cs309/2024fall/2_mstafa_4/-/settings/integrations)
...
>>>>>>> parent of a70fbae (Delete README.md)
