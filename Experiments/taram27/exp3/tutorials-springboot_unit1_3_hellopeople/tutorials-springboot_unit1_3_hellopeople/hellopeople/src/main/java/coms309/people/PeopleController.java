...
public class PeopleController {
    ...
    public Person getFirstPerson() {
        if (peopleList.isEmpty()) {
            return null; // Or handle it with an appropriate message or error code.
        }
        return peopleList.values().iterator().next(); // Get the first person in the list.
    }
    ...
    public boolean personExists(@PathVariable String firstName) {
