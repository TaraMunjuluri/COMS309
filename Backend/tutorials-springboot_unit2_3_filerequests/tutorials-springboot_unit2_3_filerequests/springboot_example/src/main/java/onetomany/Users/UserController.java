...
public class UserController {
    ...
    ResponseEntity<String> createUser(@RequestParam("avatar") MultipartFile avatar, @RequestParam("user") String userString) throws Exception {
        if (userString == null)
    ...
    @PutMapping("/users/{id}")
    ResponseEntity<User> updateUser(@PathVariable Long id, @RequestBody User request) {
        return userRepository.findById(id)
                .map(user -> {
    ...
    ResponseEntity<String> assignLaptopToUser(@PathVariable Long userId, @PathVariable int laptopId) {
        return userRepository.findById(userId)
                ...
                .orElse(ResponseEntity.status(HttpStatus.NOT_FOUND).body(failure));
    }
    ...
    ResponseEntity<?> getUserAvatar(@PathVariable Long id) throws IOException, SQLException {
        return userRepository.findById(id)
                .map(user -> {
                    try {
